...
Это не библиотека готовых процессов и не новая методология поверх DPF. Каталог используется только после понимания контекста, `FC-13` и развёртывания project-relevant concerns/results. Запись, рекомендация или заполненный шаблон не создают authority, Task, Run, CAP, файловый эффект или Admission.
